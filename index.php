...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  <img class="w3-image" src="<?php echo get_template_directory_uri(); ?>/images/london2.jpg" alt="London" width="1500" height="700">
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      <img src="<?php echo get_template_directory_uri(); ?>/images/ocean2.jpg" alt="Norway" style="width:100%">
    ...
    <div class="w3-half w3-margin-bottom">
      <img src="<?php echo get_template_directory_uri(); ?>/images/mountains2.jpg" alt="Austria" style="width:100%">
      <div class="w3-container w3-white">
